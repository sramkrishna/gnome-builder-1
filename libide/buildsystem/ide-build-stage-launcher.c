                                        ...
                                        gpointer             user_data)
{
  ...
  flags = ide_subprocess_launcher_get_flags (priv->launcher);
  ...
  ide_subprocess_launcher_set_flags (priv->launcher, flags);

  /* Now launch the process */

  subprocess = ide_subprocess_launcher_spawn (priv->launcher, cancellable, &error);
