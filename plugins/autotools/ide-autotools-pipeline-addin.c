                                   ...
                                   IdeBuildPipeline      *pipeline)
{
  ...
  if (!register_autoreconf_stage (self, pipeline, &error) ||
      ...
      !register_make_stage (self, pipeline, runtime, NULL, FALSE, IDE_BUILD_PHASE_BUILD, &error, make, "all", NULL) ||
      !register_make_stage (self, pipeline, runtime, NULL, FALSE, IDE_BUILD_PHASE_INSTALL, &error, make, "install", NULL))
    {
      g_assert (error != NULL);
